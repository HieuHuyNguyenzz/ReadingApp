...
function BookList(props) {
  ...
  const addNewBook = newBook => {
    ...
    data.append('BookName', newBook.name);
    data.append('BookImage', newBook.url);
    data.append('Genre', newBook.type);
    data.append('BookDescription', newBook.description);
    data.append('Price', newBook.price);

    bookApis.addBook(data, () => fetchBook());
  };
